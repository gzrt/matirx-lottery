...
class Canvas:
    ...
    def __init__(self, screen):
        ...
        for col in range(0, cols, 2):
            self.columns.append(Column(col, self.row_count, False))
        self.nodes = []
        self.flashers = set()

        # Draw a background
        for x in range(1, self.col_count, 2):
...
class Column:
    ...
    def __init__(self, x_coord, row_count, single_wave):
    ...
    def spawn_node(self, canvas):
        ...
        """
        if self.single_wave and self.drawing is False:
            return
